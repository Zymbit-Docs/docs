...
> NOTE: You will also need to re-map the physical electrical configuration and the host side code following the instructions here: [Alternative GPIO Pin](tutorials/alternative-gpio)
