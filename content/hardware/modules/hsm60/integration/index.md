...
To maintain the real-time clock (RTC) and tamper detection features in the event of power loss, your HSM60 can be fitted with an *Insert correct Battery information and picture of connection*.
