---
<<<<<<< HEAD:content/hardware/sen/sen400/quickstart/index.md
...
>>>>>>> origin/main:content/hardware/sen/sen400/index.md
lastmod: "2025-10-15"
draft: false
images: []
weight: 15
...
The SEN 400 Prototype Kit provides all the hardware and software components required to start implementing your application in a secure environment. 
...
{{< cardpane >}}
{{< card header="Zymbit SEN 400 Motherboard - Top" >}}
{{< figure
    src="bb400_top.png"
    alt="Motherboard 400 top"
    caption="The top and bottom of the Zymbit SEN 400 Motherboard"
    >}}
{{< /card >}}
{{< card header="Zymbit SEN 400 Motherboard- Bottom" >}}
{{< figure
    src="bb400_bottom.png"
    alt="Motherboard 400 Bottom"
    caption=""
    >}}
{{< /card >}}
{{< /cardpane >}}
...
{{< cardpane >}}
{{< card header="SEN 400 Motherboard Connectors" >}}
{{< figure
    src="bb400_table.png"
...
{{< cardpane >}}
{{< card header="SEN 400 Motherboard GPIO Pinout" >}}
{{< figure
    src="zymbit-scm-motherboard-2X1-bottom-gpio-pinout-1500px.jpg"
    alt=""
    caption="Note: the standard GPIO pinout is accessed on the bottom side of the SEN 400 Motherboard."
    >}}
{{< /card >}}
{{< /cardpane >}}
